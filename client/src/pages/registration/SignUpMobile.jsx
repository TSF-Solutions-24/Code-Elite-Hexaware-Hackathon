            ...
            <div className="w-[1440px] h-[100%] relative bg-[#f6f4eb] hidden md:block">
                ...
                <form action="" onSubmit={handleSubmit}>
                    ...
                    <div className="w-[347px] h-10 left-[784px] top-[470px] absolute">
                        <input type="number" placeholder='Enter Your OTP' className='px-2 outline-none border-2 border-black py-1 w-full rounded-xl' required />
                    </div>
                    <div className='absolute left-[790px] top-[385px]'>
                        <button className='text-blue-700 font-semibold underline'>Get OTP</button>
                    </div>
