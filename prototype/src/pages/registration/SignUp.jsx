        ...
        <div>
            <div className="relative bg-[#f6f4eb] hidden md:block">
                <div className="w-[370px] left-[787px] top-[72px] absolute">
                    ...
                    <Link to={'https://myaccount.google.com/?utm_source=sign_in_no_continue&pli=1'} className='cursor-pointer'>
                    ...
                    <div className="w-[350px] h-[70px] left-0 top-[245px] absolute">
                    ...
                    <div className="w-[367px] h-[73.31px] left-[3px] top-[332px] absolute">
                        ...
                        <div className="w-[367px] h-[42.31px] left-0 top-[31px] absolute">
                            <input type="text" placeholder='Enter Your name' className='px-2 outline-none border-2 border-black py-1 w-full rounded-xl' />
                        </div>
                    </div>
                    <form action="" onSubmit={(e) => handleSubmit(e)}>
                        ...
                        <button className='bg-[#004eec] text-white text-2xl p-1 px-[36%] text-center rounded-full absolute top-[580px] left-0'>Submit</button>
                    </form>
                </div>
