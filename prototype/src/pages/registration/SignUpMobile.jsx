        ...
        <div>
            <div className="w-[1440px] h-[100%] relative bg-[#f6f4eb] hidden md:block">
                ...
                <div className="w-[347px] h-10 left-[784px] top-[340px] absolute">
                    <input type="number" placeholder='Enter Your Number' className='px-2 outline-none border-2 border-black py-1 w-full rounded-xl' />
                </div>
                <div className="w-[347px] h-10 left-[784px] top-[440px] absolute">
                    <input type="number" placeholder='Enter Your OTP' className='px-2 outline-none border-2 border-black py-1 w-full rounded-xl' />
                </div>
                <div className="left-[786px] top-[400px] absolute text-black text-2xl font-normal font-['Lexend Deca']">Enter Your OTP</div>
