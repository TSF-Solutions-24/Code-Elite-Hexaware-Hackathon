        ...
        <div>
            <div className="w-[1440px] h-[100%] relative bg-[#f6f4eb] hidden md:block">
                ...
                <div className="w-[347px] h-10 left-[784px] top-[340px] absolute">
                    <input type="text" placeholder='eg: Bachelor of Engineering' className='px-2 outline-none border-2 border-black py-1 w-full rounded-xl' />
                </div>
                <div className="w-[347px] h-10 left-[784px] top-[440px] absolute">
                    <input type="text" placeholder='eg: Computer Science of Engineering' className='px-2 outline-none border-2 border-black py-1 w-full rounded-xl' />
                </div>
