        ...
        <div>
            <div className="w-[1440px] h-[100%] relative bg-[#f6f4eb] hidden md:block">
                ...
                <div className="w-[347px] h-10 left-[784px] top-[220px] absolute">
                    <input type="text" placeholder='eg: Python, Java' className='px-2 outline-none border-2 border-black py-1 w-full rounded-xl' />
                </div>
                <div className="w-[347px] h-10 left-[784px] top-[305px] absolute">
                    <input type="text" placeholder='eg: Java Course' className='px-2 outline-none border-2 border-black py-1 w-full rounded-xl' />
                </div>
                <div className="w-[347px] h-10 left-[784px] top-[480px] absolute">
                    <input type="text" placeholder='eg: Java Internship' className='px-2 outline-none border-2 border-black py-1 w-full rounded-xl' />
                </div>
                ...
                <input type="file" placeholder='Choose file' className='absolute left-[786px] top-[390px]'/>
                <input type="file" placeholder='Choose file' className='absolute left-[786px] top-[580px]'/>
                <div className="w-[347px] h-10 left-[790px] top-[710px] absolute">
