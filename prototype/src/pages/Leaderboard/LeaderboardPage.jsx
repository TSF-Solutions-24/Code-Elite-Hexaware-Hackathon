        ...
        showProfile ?
          <nav className='start-page md:w-[20%] w-[50%] absolute right-0 z-40 top-0 h-[780px]'>
            ...
            <div className='flex md:ml-[25%] ml-[10%] items-center gap-4 mt-8'>
              ...
              <h1 className='text-white text-xl' style={{ borderBottom: "3px solid white" }}>Leaderboard</h1>
            </div>
          </nav> : ""
      }
      <main className="flex flex-col items-start md:px-12 md:ml-10 mx-5 px-5 pt-11 rounded-3xl start-page ">
        <h1 className="md:text-4xl text-3xl font-bold text-[#E6B9A6]">Leaderboard</h1>
        <LeaderboardControls />
        <LeaderboardTable />
      </main>
      {/* Chatbot Icon */}
