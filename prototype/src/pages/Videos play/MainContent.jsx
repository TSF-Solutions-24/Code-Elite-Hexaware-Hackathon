  ...
  return (
    <main className="flex flex-col md:ml-5 md:w-[79%] h-[550px] md:h-full">
      <div className="flex flex-col w-full text-[#F6F4EB] md:mt-10 max-md:max-w-full">
        ...
        <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/1623e51efb9328e18609098eada0d5cd7b41a522456a68dabefa929d0efb83a0?placeholderIfAbsent=true&apiKey=a6343008e88b41f389a2cf613b0f8c75" alt="Java Full Stack content" className="object-contain mt-28 w-full aspect-[2.18] max-md:mt-10 max-md:mr-2.5 max-md:max-w-full" />
